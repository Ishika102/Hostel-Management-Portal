			...
			<div class="about-main">
				...
				<div class="about-top">
					...
					<div class="col-md-7 about-top-right">
						...
						<p>Morbi sapien turpis, aliquet quis elementum ut, molestie nec turpis. Duis ultrices fermentum enim ac facilisis. Phasellus laoreet rhoncus diam ut auctor. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris ut malesuada mi</p>
					</div>
	  ...
	  <div class="container">
		 ...
		 <div class="team-grids">
			 <div class="col-md-3 team-grid">
				 ...
				 <h3><a href="single.php">Sed vestibulum dui</a></h3>
			 ...
			 <div class="col-md-3 team-grid">
				 ...
				 <h3><a href="single.php">Fusce fringilla in mattis</a></h3>
				 <p>Nulla elementum vulputate quam, quis efficitur quam tempus non. Cras a dignissim purus. Ut scelerisque quis eros elementum sollicitudin.</p>
			 </div>
			 <div class="col-md-3 team-grid">
				 <img src="images/b3.jpg" alt=""/>
				 <h3><a href="single.php">Donec porta in fringilla</a></h3>
				 <p>Nulla elementum vulputate quam, quis efficitur quam tempus non. Cras a dignissim purus. Ut scelerisque quis eros elementum sollicitudin.</p>
			 </div>
			 <div class="col-md-3 team-grid">
				 <img src="images/b4.jpg" alt=""/>
				 <h3><a href="single.php">Sed non sem facilisis</a></h3>
				 <p>Nulla elementum vulputate quam, quis efficitur quam tempus non. Cras a dignissim purus. Ut scelerisque quis eros elementum sollicitudin.</p>
			 </div>
			 <div class="clearfix"></div>
		 </div>
